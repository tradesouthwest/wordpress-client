...
function bppx_profilex_profile_tab_public_style() 
{
    ...
    /*wp_localize_script( 'bp-profilex-ajax', 'bppx_ajax_object', 
 ...
 */
//remove_action( 'wp_footer', 'bppx_profilex_footer_scripts_ajax' ); 
//remove_action( 'wp_head', 'bppx_profilex_header_scripts' );

function bppx_profilex_header_scripts() 
{

    if ( is_page() ) {

    ?><script id="bppxHeader">
