 ...
 * @since 1.0.0
 */
//if ( !function_exists('delivery_validation_tsw_addtoplugin_scripts') ) :  
function delivery_validation_tsw_addplugin_scripts() 
{
    $ver      = time();
    // Register Scripts
    wp_register_script( 'delivery-validation-tsw-input', 
					   plugins_url('js/delivery-validation-tsw-input.js', __FILE__ ), 
					   array('jquery'), $ver, true );
   
    wp_enqueue_script( 'delivery-validation-tsw-input' );
