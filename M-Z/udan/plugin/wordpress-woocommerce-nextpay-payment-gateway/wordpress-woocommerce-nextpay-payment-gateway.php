...
class Nextpay_Payment
{
    ...
    public $refund_key = "";
    public $custom = "";
    public $callback_uri = "https://www.udanmarket.com/";
    public $params = array();
    public $nusoap_path = __dir__."/include/nusoap/nusoap.php";
    
    public $request_token_soap = "http://dev.znextech.com/nextpay/api/authenticate";
    //public $request_token_soap = "http://dev.znextech.com/nextpay/api/token?wsdl"; //was comntdout
    public $request_token_http = "http://dev.znextech.com/nextpay/api/authenticate";
    
    public $request_verify_soap = "http://dev.znextech.com/nextpay/api/generateIpin";
    //public $request_verify_soap = "http://dev.znextech.com/nextpay/api/verify?wsdl"; //was comntdout
    public $request_verify_http = "http://dev.znextech.com/nextpay/api/generateIpin";
    
    public $request_refund_soap = "http://dev.znextech.com/nextpay/refund.wsdl";
    //public $request_refund_soap = "http://dev.znextech.com/nextpay/api/refund?wsdl"; //was comntdout
    public $request_refund_http = "http://dev.znextech.com/nextpay/refund.http";
    
    // orig http://dev.znextech.com/nextpay/api/payment
    public $request_payment = "http://dev.znextech.com/nextpay/api/merchant-payments";
